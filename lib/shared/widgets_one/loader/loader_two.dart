...
class LoaderTwo extends StatefulWidget {
  const LoaderTwo({super.key, this.colors, this.duration});
  final List<Color>? colors;
  final Duration? duration;

  @override
  _LoaderTwoState createState() =>
      _LoaderTwoState(this.colors!, this.duration!);
}
...
class _LoaderTwoState extends State<LoaderTwo>
  ...
  void initState() {
    ...
    for (int i = 0; i < colors.length; i++) {
      final animation = tweenAnimations[i].animate(CurvedAnimation(
          parent: controller,
